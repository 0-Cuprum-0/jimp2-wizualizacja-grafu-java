...
\begin{document}
	...
	\begin{enumerate}
		...
		\item Zapisywanie informacji o położeniu wierzchołków po ich rozmieszczeniu do pliku tekstowego.
...
DB   4  2  1.407
    ...
    \begin{itemize}
        ...
        \item writeToTxt -- pozwala na zapisanie pozycji wierzchołków do pliku tekstowego.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item saveFileTxtAction -- otwiera okno dialogowe do zapisu pliku, wywołuje funkcje zapisującą pozycję wierzchołków do pliku TXT.
    \end{itemize}
